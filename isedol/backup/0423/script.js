...
//#region mainPage
    ...
    const videoCards = ref(
      Array.from({ length: 6 }, (_, i) => ({
        ...
        youtubeUrl: [
          `https://www.youtube.com/embed/fnZ1yJoynGk?autoplay=1`,
          `https://www.youtube.com/embed/UlzpAbJpckk?autoplay=1`,
          `https://www.youtube.com/embed/XimK3bfEtpo?autoplay=1`,
          `https://www.youtube.com/embed/z1_gpZIPQ3s?autoplay=1`,
          `https://www.youtube.com/embed/d_HOsDFpIlc?autoplay=1`,
          `https://www.youtube.com/embed/tdND3culOl8?autoplay=1`,
        ],
        showVideo: false,
      }))
    );
    ...
    const fetchPlaybarPlaylist = async (playlistId) => {
      ...
      if (plError) {
        ...
        if (sError) {
          ...
          // ❗️ 자동 재생 제거:
          // playCurrentSong();
          // 사용자가 버튼을 클릭했을 때만 재생을 시작하도록 합니다.
        }
      }
    };
